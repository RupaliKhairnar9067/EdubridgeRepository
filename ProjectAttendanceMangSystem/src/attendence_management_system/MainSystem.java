...
public class MainSystem {
	...
	static String password="teacherabc";
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			System.out.println("Enter the operation you like to proceed with:");
		...
		break;
			...
			boolean chk=MainSystem.CheckPassword(pass);
			if(chk==true)
			{
			...
			else
			{
				...
				break;
				case 4: MainSystem.UpdatePassword();
				break;
			}
		}
